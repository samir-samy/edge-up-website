 ...
 * Description: Fetch JSON data and inject it into the DOM
 */
...
async function loadProjectData() {
    try {
        ...
        if (!response.ok) {
            throw new Error("لم يتم العثور على ملف البيانات (JSON)");
        }
        ...
        // 3. عرض بيانات المؤسس (Founder Section)
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled mb-4">
                                    ${(data.founder.academic_credentials || []).map(item => `
        ...
        if (contactDiv && data.contact) {
            contactDiv.innerHTML = `
                <div class="d-flex flex-column gap-2">
                    ...
                    <a href="https://wa.me/${data.contact.whatsapp.replace('+', '')}" 
                       target="_blank" 
                       class="text-decoration-none text-white opacity-75">
